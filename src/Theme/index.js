...
const theme = (darkMode, color) => ({
	...
	navMode: darkMode ? '#01110B': '#01110B',
	panelColor: darkMode ? '#01110B' : '#FFFFFF',
	backgroundColor: darkMode ? '#212429' : '#01110B',

	uniswapPink: darkMode ? '#01110B' : 'black',
	...
	onlyLight: darkMode ? '#01110B' : '#FFFFFF',
	divider: darkMode ? 'rgba(43, 43, 43, 0.435)' : 'rgba(43, 43, 43, 0.035)',

	//primary colors
	primary1: darkMode ? '#2172E5' : '#01110B',
	...
	// color text
	primaryText1: darkMode ? '#6da8ff' : '#01110B',

	// secondary colors
	secondary1: darkMode ? '#2172E5' : '#01110B',
	...
	link: '#2172E5',
	blue: '#2f80ed',
	background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #01110B 0%, #fff 0%)`,
