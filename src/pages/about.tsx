		...
		<Layout title="DAppView - DeFi Dashboard" defaultSEO>
			...
			<Panel style={{ marginTop: '6px' }}>
				<DashGrid style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
					...
					<TYPE.main>
					DAppView is the largest TVL aggregator for DeFi (Decentralized Finance). Our data is fully{' '}
						{/* <Link href="https://github.com/DefiLlama/DefiLlama-Adapters">open-source</Link>  */}
						{' '}<Link href="#">open-source</Link>{' '}
						and maintained by a team of
					...
					<Divider />
					<TYPE.main>
						{/* Contact us on <Link href="https://twitter.com/defillama">Twitter</Link> */}
						Contact us on <Link href="#">Twitter</Link>{' '}
						 or{' '}
			...
			<Panel style={{ marginTop: '6px' }}>
				<DashGrid style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
					...
					<Divider />
					<TYPE.main>
					DAppView&apos;s design is based on <Link href="https://github.com/Uniswap/uniswap-info">Uniswap.info</Link>
					</TYPE.main>
				</DashGrid>
			</Panel>
		</Layout>
